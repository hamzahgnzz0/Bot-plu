            ...
            for (let name in global.plugins) {
                ...
                if ((usedPrefix = (match[0] || '')[0])) {
                    ...
                    if (!isPrems && plugin.limit && global.db.data.users[m.sender].limit < plugin.limit * 1) {
                        this.reply(m.chat, `Limit anda habis, silahkan beli melalui *${usedPrefix}buy atau chat owner untuk meminta limit ketik .owner*`, m)
		...
		case 'invite_v4':
                if (chat.welcome) {
                    ...
                    for (let user of participants) {
                        let pp = 'https://telegra.ph/file/6de3ad177c1b3a02e04a3.jpg'
                        try {
...
global.dfail = (type, m, conn) => {
    let msg = {
        rowner: 'Perintah ini hanya dapat digunakan oleh anggazyy66x!',
        owner: 'Perintah ini hanya dapat digunakan oleh anggazyy66x!',
